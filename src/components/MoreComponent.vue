  ...
  <section class="container-fluid blink">
    ...
    <div class="row justify-content-center">
      <div class="col-12 text-retro pt-4">
        ...
        <h3 class="text-center fs-lg text-decoration-underline">GregsList, Riskier Fire, & Get Outside Photography</h3>
      </div>
      <div class="col-12 d-flex justify-content-center pt-5">
        <a href="https://github.com/EricTimRussell/gregslist-laravel-vue/tree/main" target="_blank">
          <img class="gregslist my-3" src="../assets//images/WorksBG/GregsListUnderConstruction.png"
            alt="under construction road sign">
        </a>
      </div>
      <div class="col-10 text-retro text-center">
        <span class="fs-lg">GregsList</span>
      ...
      <div class="col-12 d-flex justify-content-center pt-3">
        <a target="_blank" href="https://github.com/EricTimRussell/riskierFire">
          <img class="riskier-2 my-3" src="../assets/images/More/Riskier-logo-bg.png" alt="riskier logo">
        </a>
      </div>
      <div class="col-10 text-retro text-center">
        <span class="fs-lg">Riskier</span>
      ...
      <div class="col-12 pt-3">
        <a class="d-flex justify-content-center" target="_blank" href="https://github.com/EricTimRussell/pam-photo">
          <img class="photo-logo my-3" src="../assets/images/More/Get_Outside_Photography.png"
            alt="get outside photography logo">
        </a>
      </div>
      <div class="col-10 text-retro text-center">
        <span class="fs-lg">Get Outside Photography</span>
